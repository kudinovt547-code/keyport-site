...
export function renderTestimonials(): string {
  return `
    <section class="kp-section bg-section-soft" id="testimonials">
      <div class="kp-narrow flex flex-col gap-16">
        <div class="kp-eyebrow" data-reveal>07 — Voices</div>
        <div class="flex flex-col gap-16">
          ${testimonials.map(
            (t, i) => `
              <figure class="grid md:grid-cols-12 gap-8 items-start border-t pt-12" style="border-color: var(--line)" data-reveal data-reveal-delay="${i + 1}">
